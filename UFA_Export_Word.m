...
imgStyle1 = {HAlign('center'),Width('600px'),Height('400px')};
...
imgStyle2 = {HAlign('center'),Width('900px'),Height('500px')};
...
imgStyle = {HAlign('center'),Width('600px'),Height(' 400px')};

U_fiber_counts.Style = imgStyle;

U_fiber_length.Style = imgStyle;

imgStyle3 = {HAlign('center'),Width('900px'),Height('500px')};
