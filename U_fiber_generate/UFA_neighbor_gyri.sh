...
mrcalc ${Input_dir}/mri/aparc.a2009s+aseg.mgz 12159 -eq ${Output_dir}/rh_S_oc_sup_transversal.mif -force

mrconvert ${Output_dir}/rh_S_oc_sup_transversal.mif ${Output_dir}/rh_S_oc_sup_transversal.nii -force
