...
#wm_cluster_from_atlas.py -f 100000 -l ${min_len} -j ${num_of_processor} ${CurrentFolder}/TractRegistration/whole_tract/output_tractography/whole_tract_reg.vtk ${CurrentFolder}/ORG-Atlases-1.1.1/ORG-800FC-100HCP/ ${CurrentFolder}/FiberClustering/InitialClusters/

wm_cluster_from_atlas.py -l 20 -j ${num_of_processor} ${CurrentFolder}/TractRegistration/whole_tract/output_tractography/whole_tract_reg.vtk ${CurrentFolder}/ORG-Atlases-1.1.1/ORG-800FC-100HCP/ ${CurrentFolder}/FiberClustering/InitialClusters/
